...
<div class="col-xs-6 col-md-offset-3" style="padding-top: 100px;position: relative">
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            <form action="announcement_add_do.html" method="post" id="addannouncement" >
                ...
                <div class="input-group" style="padding-top: 20px;">
                    <span  class="input-group-addon">内容</span>
                           <input  type="text" class="form-control " style="height: 300px " name="article" id="article" >
                </div>
               ...
               <script>
                       $("#addannouncement").submit(function () {
