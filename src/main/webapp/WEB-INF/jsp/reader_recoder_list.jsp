            ...
            <c:forEach items="${allRecord}" var="record">
                                       ...
                                       <c:set var="flag" value="false"/>
                                                                       <c:forEach var="unSign" items="${unSignedRecord}">
                                                                           <c:if test="${unSign.record_id eq record.record_id}">
                                                                               <c:set var="flag" value="true"/>
                                                                           </c:if>
                                                                       </c:forEach>

                                                                       <c:if test="${flag}">
                                                                            <c:if test="${now()>record.start_time}">
                                                                           <td><a href="record_sign_do.html?record_id=<c:out value="${record.record_id}"></c:out>">
                                                                       ...
                                                                       <c:if test="${not flag}">
                                                                               <td><a href="record.html?record_id=<c:out value="${record.record_id}"></c:out>">
                                                                                   <button type="button" class="btn btn-danger btn-xs">取消签到</button>
                                                                               </a></td>
                                                                           </c:if>
                                                                       </c:if>
                                   </tr>
